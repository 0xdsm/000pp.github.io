+++
title = "(PT-BR) 101 Security Descriptor"
date = 2024-10-24
[taxonomies]
...
![Security Descriptor em formato binário extraído via LDAP](/assets/security-descriptor/image1.jpg)
...
![Diagrama de ACL, ACE, DACL e SACL](/assets/security-descriptor/image2.jpg)
...
![Estrutura expandida de um Security Descriptor](/assets/security-descriptor/image3.jpg)
...
![Tabela de permissões ACE_MASK](/assets/security-descriptor/image4.jpg)
...
![Resultado da ferramenta breads listando permissões](/assets/security-descriptor/image5.jpg)
...
- [github.com/fortra/impacket — ldaptypes.py](https://github.com/fortra/impacket/blob/f8899e65f16c50b871863528d419cfb701a5a3e3/impacket/ldap/ldaptypes.py)
- [learn.microsoft.com — AD Schema](https://learn.microsoft.com/en-us/windows/win32/adschema/)
- [installsetupconfig.com — Access Control List ACL](https://www.installsetupconfig.com/win32programming/accesscontrollistacl2_1.html)
- [learn.microsoft.com — Access Control Lists](https://learn.microsoft.com/en-us/windows/win32/secauthz/access-control-lists)
- [learn.microsoft.com — Security Descriptor String Format](https://learn.microsoft.com/en-us/windows/win32/secauthz/security-descriptor-string-format)
- [learn.microsoft.com — Security Glossary A](https://learn.microsoft.com/en-us/windows/win32/secgloss/a-gly)
- [learn.microsoft.com — Security Glossary D](https://learn.microsoft.com/en-us/windows/win32/secgloss/d-gly)
- [learn.microsoft.com — MS-DTYP: SECURITY_DESCRIPTOR](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-dtyp/4f4251cc-23b6-44b6-93ba-69688422cb06)
- [learn.microsoft.com — MS-DTYP: ACE](https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-dtyp/7d4dac05-9cef-4563-a058-f108abecce1d)
- [learn.microsoft.com — ADS_RIGHTS_ENUM](https://learn.microsoft.com/en-us/windows/win32/api/iads/ne-iads-ads_rights_enum)
